...
var na = function(r, e, t, i) {
    if (e && typeof e == "object" || typeof e == "function") for(var a = ra(e), n = 0, o = a.length, s; n < o; n++)s = a[n], !ia.call(r, s) && s !== t && ft(r, s, {
        get: (function(u) {
            return e[u];
        }).bind(null, s),
...
var V = function(r, e, t) {
    return t = r != null ? ea(aa(r)) : {}, na(e || !r || !r.__esModule ? ft(t, "default", {
        value: r,
        enumerable: !0
    }) : t, r);
};
...
var rt = B(function(Vs, Dr) {
    te();
    var tt = Ye(), Qa = Xe(), za = $e(), Ka = Ze(), Ya = kr(), xr = "http://www.w3.org/1999/xhtml";
    Dr.exports = I;
    function I(r, e, t) {
...
var Pr = B(function(Qs, Or) {
    te();
    var Xa = Ye(), $a = vr(), Za = hr(), Re = rt(), ei = Rr(), ti = Ar(), ri = Xe(), ai = $e(), ii = Ze();
    Or.exports = Be;
    function Be() {
...
var nt = B(function(Ks, Cr) {
    var Nr = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable", oi = Lr(), qe;
...
var Y = {
    ...
    var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t, i, a, n, o, s = r ? [
        ...
        console
    ], u = (t = console.trace).bind.apply(t, j(s)), f = (i = console.info).bind.apply(i, j(s)), g = (a = console.debug).bind.apply(a, j(s)), k = (n = console.warn).bind.apply(n, j(s)), h = (o = console.error).bind.apply(o, j(s)), c = e;
    return {
        trace: function() {
...
var Ne = V(J()), sa = {
    exists: function() {
        var r = Ne.default.performance, e = r && r.timing;
        return e !== void 0;
    },
...
var Me = function(r) {
    ...
    var u = function(m, p) {
        ...
        var _ = p.levels, d = p.audioTracks, y = p.url, T = p.stats, E = p.networkDetails, S = p.sessionData, L = {}, M = {};
        ...
        var P = Me(T), R = P.bytesLoaded, Z = P.requestStart, we = P.responseStart, Te = P.responseEnd;
    ...
    var g = function(m, p) {
        var _ = p.details, d = p.level, y = p.networkDetails, T = p.stats, E = Me(T), S = E.bytesLoaded, L = E.requestStart, M = E.responseStart, P = E.responseEnd, R = _.fragments[_.fragments.length - 1], Z = s(R) + o(R.duration);
        u("requestcompleted", {
            request_event_type: m,
    ...
    var k = function(m, p) {
        var _ = p.details, d = p.networkDetails, y = p.stats, T = Me(y), E = T.bytesLoaded, S = T.requestStart, L = T.responseStart, M = T.responseEnd;
        u("requestcompleted", {
            request_event_type: m,
    ...
    var h = function(m, p) {
        var _ = p.stats, d = p.networkDetails, y = p.frag;
        _ = _ || y.stats;
        var T = Me(_), E = T.bytesLoaded, S = T.requestStart, L = T.responseStart, M = T.responseEnd, P = d ? Se(d) : void 0, R = {
            request_event_type: m,
            request_bytes_loaded: E,
            request_start: S,
            request_response_start: L,
    ...
    var c = function(m, p) {
        var _ = p.frag, d = _.start, y = s(_), T = {
    ...
    var v1 = function(m, p) {
        var _ = p.type, d = p.details, y = p.response, T = p.fatal, E = p.frag, S = p.networkDetails, L = (E == null ? void 0 : E.url) || p.url || "", M = S ? Se(S) : void 0;
    ...
    var x = function(m, p) {
        var _ = p.level, d = t.levels[_];
        if (d && d.attrs && d.attrs.BANDWIDTH) {
            var y = d.attrs.BANDWIDTH, T, E = parseFloat(d.attrs["FRAME-RATE"]);
    ...
    t.on(a.Events.LEVEL_SWITCHED, x), t._stopMuxMonitor = function() {
        t.off(a.Events.MANIFEST_LOADED, f), t.off(a.Events.LEVEL_LOADED, g), t.off(a.Events.AUDIO_TRACK_LOADED, k), t.off(a.Events.FRAG_LOADED, h), t.off(a.Events.FRAG_CHANGED, c), t.off(a.Events.ERROR, v1), t.off(a.Events.FRAG_LOAD_EMERGENCY_ABORTED, w), t.off(a.Events.LEVEL_SWITCHED, x), t.off(a.Events.DESTROYING, t._stopMuxMonitor), delete t._stopMuxMonitor;
...
var Nt = function(r, e) {
    ...
    var u = {}, f = function(_) {
        ...
        var d = _.type, y = _.fragmentModel, T = _.chunk, E = f(y);
        k({
            type: d,
            request: E,
            chunk: T
        ...
        var d = _.type, y = _.chunk, T = _.request, E = (y || {}).mediaInfo, S = E || {}, L = S.type, M = S.bitrateList;
        M = M || [];
        var P = {};
        ...
        var R = Nt(T, t), Z = R.requestStart, we = R.requestResponseStart, Te = R.requestResponseEnd, G = R.requestResponseHeaders, oe = R.requestMediaDuration, Ve = R.requestHostname, je = R.requestUrl, We = R.requestId;
        o("requestcompleted", {
            request_event_type: d,
            request_start: Z,
            request_response_start: we,
    ...
    var v1 = {
        ...
        if (v1.video && typeof v1.video.bitrate == "number") {
            ...
            if (v1.audio && typeof v1.audio.bitrate == "number" && (_ += v1.audio.bitrate), _ !== v1.totalBitrate) return v1.totalBitrate = _, {
                ...
                video_source_codec: fa(v1.video.codec)
            };
        }
    }, x = function(_, d, y) {
    ...
    var p = function(_) {
        var d = _.error, y, T, E = (d == null || (y = d.data) === null || y === void 0 ? void 0 : y.request) || {}, S = (d == null || (T = d.data) === null || T === void 0 ? void 0 : T.response) || {};
    ...
    t.on("error", p), t._stopMuxMonitor = function() {
...
var Gt = 5 * 60 * 1e3, wa = function r(e) {
    "use strict";
...
var Ea = function() {
    ...
    function r(e) {
        var t = this;
        D(this, r), l(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
...
var Xt = function(e, t) {
    ...
    function r(e) {
        ...
        e.on("adbreakstart", function() {
            ...
            }, n), Xt(t._adRequests, n), O(e.data, "view_ad_request_count"), t.inPrerollPosition() && (e.data.view_preroll_requested = !0, t._adHasPlayed || O(e.data, "view_preroll_request_count"));
        }), e.on("adresponse", function(a, n) {
            n = Object.assign({
                ad_request_id: "generatedAdRequestId" + t._currentAdResponseNumber++
            }, n), Xt(t._adResponses, n);
        ...
        function i(a, n, o) {
            ...
            if (typeof document != "undefined") {
                ...
                for(var f = document.cookie ? document.cookie.split("; ") : [], g = /(%[0-9A-Z]{2})+/g, k = 0; k < f.length; k++){
                    ...
                    try {
                        var v1 = h[0].replace(g, decodeURIComponent);
                        if (c = t.read ? t.read(c, v1) : t(c, v1) || c.replace(g, decodeURIComponent), this.json) try {
                            c = JSON.parse(c);
                        } catch (w) {}
                        if (a === v1) {
                            s = c;
...
var tr = "muxData", Oa = function(r) {
    ...
    var e = rr();
    return e.mux_viewer_id = e.mux_viewer_id || ee(), e.msn = e.msn || Math.random(), ar(e), {
        mux_viewer_id: e.mux_viewer_id,
        mux_sample_number: e.msn
    };
}, nr = function() {
    var e = rr(), t = A.now();
    return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = ee(), e.sst = t), e.sex = t + 25 * 60 * 1e3, ar(e), {
        session_id: e.sid,
        session_start: e.sst,
...
var or = V(J()), sr = function() {
    ...
    var e = or.default.navigator, t = e && (e.connection || e.mozConnection || e.webkitConnection);
    return t && t.type;
};
...
var ci = typeof Mr.default.exitPictureInPicture == "function" ? function(r) {
    return r.length <= ui;
} : function(r) {
    return !1;
}, Hr = function(r, e, t, i) {
...
var _i = [
    ...
    "ended",
    "viewend"
], mi = 10 * 60 * 1e3, Ur = function() {
    "use strict";
    function r(e, t) {
        var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        D(this, r);
        var a, n, o, s, u, f, g, k, h, c, v1, w;
        ...
        var p;
        this.respectDoNotTrack = (p = this.options.respectDoNotTrack) !== null && p !== void 0 ? p : !1, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.pageLevelData = {
            ...
            page_url: Ue.default === null || Ue.default === void 0 || (w = Ue.default.location) === null || w === void 0 ? void 0 : w.href
    ...
    return N(r, [
        {
            ...
            value: function(t, i) {
                if (!(!t || !(i != null && i.view_id))) {
                    ...
                    var a = this.disableCookies ? {} : nr(), n = fe(ue({}, this.pageLevelData, i, a, this.viewerData), {
                        event: t,
                        env_key: this.envKey
                    });
                    n.user_id && (n.viewer_user_id = n.user_id, delete n.user_id);
                    var o, s = ((o = n.mux_sample_number) !== null && o !== void 0 ? o : 0) >= this.sampleRate, u = this._deduplicateBeaconData(t, n), f = ve(u);
...
var hi = function r(e) {
    ...
    var t = 0, i = 0, a = 0, n = 0, o = 0, s = 0, u = 0, f = function(h, c) {
        var v1 = c.request_start, w = c.request_response_start, x = c.request_response_end, m = c.request_bytes_loaded;
        n++;
        var p, _;
        if (w ? (p = w - (v1 != null ? v1 : 0), _ = (x != null ? x : 0) - w) : _ = (x != null ? x : 0) - (v1 != null ? v1 : 0), _ > 0 && m && m > 0) {
            var d = m / _ * 8e3;
    ...
    function t(i, a, n) {
        ...
        var s = {
            ...
            emitTranslator: function() {
                for(var h = arguments.length, c = new Array(h), v1 = 0; v1 < h; v1++)c[v1] = arguments[v1];
                return c;
            },
        ...
        o.on("playerready", function(h, c) {
            ...
            o.on(h, function(c, v1) {
                h.indexOf("ad") !== 0 && this._updateStateData(), Object.assign(this.data, v1), this._sanitizeData();
...
function st(r, e, t) {
    ...
    var k = {
        ...
        getStateData: function() {
            var v1, w, x, m = ((v1 = (w = this).getPlayheadTime) === null || v1 === void 0 ? void 0 : v1.call(w)) || f(a.currentTime), p = this.hlsjs && this.hlsjs.url, _ = this.dashjs && typeof this.dashjs.getSource == "function" && this.dashjs.getSource(), d = {
                ...
                video_source_url: p || _ || a.currentSrc,
    ...
    a.mux.destroy = function() {
        ...
        }), delete a.mux.listeners, a.mux.destroy = h, a.mux.swapElement = h, a.mux.emit = h, a.mux.addHLSJS = h, a.mux.addDashJS = h, a.mux.removeHLSJS = h, a.mux.removeDashJS = h, a.mux.updateData = h, a.mux.setEmitTranslator = h, a.mux.setStateDataTranslator = h, a.mux.setGetPlayheadTime = h, a.mux.deleted = !0, r.emit(n, "destroy");
    }, a.mux.swapElement = function(c) {
        var v1 = H(se(c), 3), w = v1[0], x = v1[1], m = v1[2];
        if (w) {
        ...
        w.muxId = a.muxId, delete a.muxId, w.mux = w.mux || {}, w.mux.listeners = Object.assign({}, a.mux.listeners), delete a.mux.listeners, Object.keys(w.mux.listeners).forEach(function(p) {
            a.removeEventListener(p, w.mux.listeners[p], !1), w.addEventListener(p, w.mux.listeners[p], !1);
        }), w.mux.swapElement = a.mux.swapElement, w.mux.destroy = a.mux.destroy, delete a.mux, a = w;
        ...
        c === "error" && !t.automaticErrorTracking || (a.mux.listeners[c] = function() {
            ...
            if (c === "error") {
                ...
                v1.player_error_code = a.error.code, v1.player_error_message = Si[a.error.code] || a.error.message;
            }
            r.emit(n, c, v1);
...
Fe.prototype.processLine = function(r) {
    var e = r.indexOf(":"), t = Oi(r, e), i = t[0], a = t.length === 2 ? _t(t[1]) : void 0;
...
var Ni = "mux-embed", Ci = "5.11.0", Mi = "2.1", C = {}, ne = function(e) {
    var t = arguments;
...
//# sourceMappingURL=node_modules_8fbc0466._.js.map