...
<section className="features py-4">
  <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
    ...
    <div className="box flex items-center gap-x-3 justify-center p-4 bg-primary/20 rounded-lg">
      <img src="https://eslam-yahia-physics.com/AssetsUser/Imgs/Video%20Presentation.svg" alt="" className="w-20 h-20" />
    ...
    <div className="box flex items-center gap-x-3 justify-center p-4 bg-primary/20 rounded-lg">
      <img src="https://eslam-yahia-physics.com/AssetsUser/Imgs/Video.svg" alt="" className="w-20 h-20" />
      <div className="text mt-3">
    ...
    <div className="box flex items-center gap-x-3 justify-center p-4 bg-primary/20 rounded-lg">
      <img src="https://eslam-yahia-physics.com/AssetsUser/Imgs/Exam%20Time.svg" alt="" className="w-20 h-20" />
      <div className="text mt-3">
