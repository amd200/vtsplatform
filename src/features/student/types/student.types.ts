...
export type GetChapterDetailsRepsone = BaseResponse<Chapter>;
export type GetLessonDetailsRepsone = BaseResponse<Lesson>;
...
export type EWalletRepsone = BaseResponse<string>;
