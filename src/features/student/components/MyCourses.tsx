...
function MyCourses({ title, link, courses, isLoading, showAll = true, withBackground = true }: { courses: Course[]; link: string; isLoading: boolean; showAll?: boolean; withBackground?: boolean; title: string }) {
  return (
    <section>
      <div className="container">
        <div className="flex items-center justify-between">
          ...
          {showAll && (
            <Button asChild>
              <Link href={link ? link : "/student/mycourses"}>عرض المزيد</Link>
            </Button>
          )}
        </div>
