...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: "/student/mypayments", label: "مدفوعاتي", icon: <CreditCard size={20} /> },
  ...
  return (
    <aside className={`${isOpen ? "w-64" : "w-20"} h-screen max-lg:hidden  fixed start-0 z-[101] top-0 bg-primary border-e shadow-sm transition-all duration-300 flex flex-col`}>
